...
| -------- | -------- | -------- |
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | Aponte Pablo, Isabel Luisa <br>*AV1* <br> Presentó el proceso de needfinding y el análisis competitivo del proyecto. <br> <br> *TB1* <br> Presentó el módulo de monetización y tienda, explicando el flujo de compra de gemas, avatares y cosméticos, así como la validación de saldo y la lógica del multiplicador de XP. <br> <br> Astocondor Bazan, Alejandra Isabel <br> *AV1* <br> Explicó las User Stories, épicas, style guidelines y los flujos (User Flow y Wireflow). <br> <br> *TB1* <br> Expuso el desarrollo del frontend del módulo de quests, abarcando la selección, inicio, seguimiento de pasos y finalización de miniactividades, retos diarios y rachas. <br> <br> Dulanto Espino, Leo César <br> *AV1* <br> Sustentó los diagramas de arquitectura (modelo C4) y el Big Picture Event Storming. <br> <br> *TB1* <br> Sustentó el módulo de comunidad, explicando la integración con una API de mapas real para visualizar eventos comunitarios geolocalizados, inscripciones y logros compartidos. <br> <br> Diaz Martinez, Alexther Kamil <br> *AV1* <br> Explicó el diagrama de clases, así como el deployment y configuraciones del sistema. <br> <br> *TB1* <br> Presentó el módulo de perfil de usuario, explicando la gestión de compromisos y el seguimiento del progreso individual. <br> <br> Laura Acosta, Victor Jhosuefr <br> *AV1* <br> Explicó el Problem Statement y los elementos de Lean UX (assumptions, hypothesis y enfoque del producto). <br> <br> *TB1* <br> Expuso el módulo de ranking, detallando el uso de una API en tiempo real para mostrar clasificaciones semanales, mensuales y globales de usuarios. <br> <br> | *AV1* <br> El equipo logró comunicar de manera clara y estructurada los distintos componentes del proyecto, adaptando el lenguaje según el tipo de contenido (UX, técnico y de negocio). Se evidenció dominio de los temas y coherencia en la exposición general. <br> <br> *TB1* <br> El equipo demostró capacidad para comunicar oralmente funcionalidades técnicas concretas ante diferentes audiencias, explicando tanto la lógica de negocio como las decisiones de implementación de cada módulo desarrollado. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia** | Aponte Pablo, Isabel Luisa <br>*AV1* <br> Redactó el análisis competitivo, Ubiquitous Language y documentación de prototipos. <br> <br> *TB1* <br> Documentó el módulo de tienda y monetización, describiendo los flujos de compra de gemas, validación de pagos fallidos, adquisición de avatares y cosméticos, y activación del multiplicador de XP. <br> <br> Astocondor Bazan, Alejandra Isabel <br> *AV1* <br> Redactó antecedentes, problemática, Lean UX Problem Statement y flujos (User Flow y Wireflow). <br> <br> *TB1* <br> Redactó la documentación del frontend del módulo de quests, detallando la implementación de miniactividades guiadas, retos ambientales diarios, sistema de puntos y rachas. <br> <br> Dulanto Espino, Leo César <br> *AV1* <br> Documentó Lean UX (assumptions, hypothesis, canvas) y arquitectura de software. <br> <br> *TB1* <br> Documentó el módulo de comunidad, incluyendo la integración con API de mapas, inscripción a actividades comunitarias, visualización de logros compartidos y eventos ambientales. <br> <br> Diaz Martinez, Alexther Kamil <br> *AV1* <br> Elaboró documentación de user personas, journey mapping, empathy mapping y diagramas de clases. <br> <br> *TB1* <br> Elaboró la documentación del módulo de perfil, cubriendo el registro, edición y actualización de compromisos del usuario. <br> <br> Laura Acosta, Victor Jhosuefr <br> *AV1* <br> Redactó user stories, product backlog, impact mapping y style guidelines. <br> <br> *TB1* <br> Documentó el módulo de ranking, especificando los endpoints implementados, el recálculo en tiempo real y la visualización de posición del usuario autenticado en distintos periodos. <br> <br> | *AV1* <br> El equipo desarrolló documentación clara, organizada y alineada a los distintos enfoques del proyecto (UX, negocio y técnico). Se mantuvo consistencia en la redacción y coherencia entre secciones, facilitando la comprensión integral del sistema. <br> <br> *TB1* <br> El equipo produjo documentación técnica y funcional organizada para cada módulo, reflejando con claridad las decisiones de implementación y facilitando la comprensión del sistema tanto para perfiles técnicos como no técnicos. |
...
En conclusión, el proyecto EcoMind cuenta con una propuesta de valor sólida y diferenciadora que combina educación ambiental con gamificación, participación familiar y una experiencia digital accesible. La investigación realizada con usuarios, el análisis del mercado competitivo y el diseño de la arquitectura técnica proporcionan una base robusta para proceder con confianza al desarrollo del producto mínimo viable. El proyecto está listo para avanzar a la siguiente fase de construcción y validación con usuarios reales, con el entendimiento claro de que algunos supuestos críticos requieren confirmación empírica durante el uso real de la plataforma.
...
Como primer paso, es fundamental proceder con el desarrollo completo del Producto Mínimo Viable (MVP) que integre las funcionalidades principales que han sido validadas con los usuarios. Este MVP debe incluir un backend sólido que gestione todos los aspectos técnicos necesarios, así como un frontend o interfaz de usuario que sea intuitiva y atractiva para el público objetivo. Específicamente, el sistema debe permitir a los escolares acceder a una variedad de mini-retos ambientales organizados por temas (agua, energía, reciclaje y biodiversidad), acumular puntos e insignias a medida que completan actividades, ver su progreso en un ranking y, especialmente importante, invitar a sus padres a participar en retos conjuntos. Para los padres, la plataforma debe proporcionar reportes claros y accesibles que muestren el progreso de sus hijos y cómo están avanzando en el desarrollo de hábitos sostenibles. Adicionalmente, el sistema debe funcionar aunque no exista conexión a internet, permitiendo que los usuarios continúen usando la aplicación y sincronicen sus datos cuando vuelvan a conectarse. Esta fase de desarrollo debe completarse de manera ágil, manteniendo contacto regular con posibles usuarios para asegurar que se está construyendo exactamente lo que necesitan.

Respecto a cómo hacer que la plataforma crezca y llegue a más usuarios, se recomienda enfocarse inicialmente en canales de bajo costo y alta relevancia. Las alianzas estratégicas con colegios e instituciones educativas deben ser el primer frente, posicionando a EcoMind como una herramienta que refuerza y complementa el aprendizaje ambiental que ya se enseña en las escuelas. Las redes sociales como Instagram y TikTok son canales valiosos para conectar con padres jóvenes y educadores, compartiendo historias de éxito, testimonios de familias que ya usan la plataforma, y contenido educativo ambiental. Es recomendable también colaborar con influencers locales que estén apasionados por temas ambientales, pero manteniéndose enfocado en personajes con alcance moderado (no mega influencers) para mantener costos razonables. La narrativa de comunicación debe enfatizar que EcoMind no es solo "un juego más" sino una herramienta que ayuda a los niños a desarrollar hábitos ambientales reales que durarán de por vida.

En cuanto al diseño y la experiencia del usuario, es fundamental mantener un proceso continuo de prueba e iteración incluso después de lanzar la versión inicial. Se recomienda realizar sesiones regulares de prueba de usabilidad (idealmente mensuales) con grupos representativos de usuarios para identificar puntos donde la interfaz es confusa, poco atractiva o difícil de usar. El equipo debe recordar que muchos de los usuarios estará utilizando dispositivos móviles con pantallas pequeñas y conexiones a internet que no siempre son estables, por lo que optimizar la experiencia para estos escenarios es crítico. La accesibilidad también debe ser una consideración importante desde el inicio, asegurando que la plataforma pueda ser usada por niños con diferentes capacidades. Adicionalmente, personalizar la experiencia según el rol del usuario (un niño ve algo diferente a lo que ve un padre) puede mejorar significativamente la satisfacción y utilidad percibida.

A nivel técnico e infraestructura, es importante construir una plataforma que pueda crecer sin problemas significativos. Aunque al inicio el proyecto podría tener cientos de usuarios, el objetivo es eventualmente tener decenas de miles. El equipo debe garantizar que la plataforma sea confiable y rápida incluso cuando la cantidad de usuarios aumente. Especialmente importante es que el sistema de sincronización offline funcione de manera flawless, asegurando que cuando los usuarios vuelvan a tener conexión, todos sus puntos, retos completados e insignias se guarden correctamente sin pérdida de datos. El equipo también debe implementar un sistema de monitoreo continuo que alerte rápidamente si algo falla, permitiendo una respuesta rápida ante problemas.
